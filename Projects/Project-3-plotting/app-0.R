...
ui <- fluidPage(
  ...
  selectInput("response", "Response var:", 
              choices = c("Choose Response var" = "",
                          "mpg from mtcars" = "mtcars$mpg",
                          "Sepal length from iris" = "iris$Sepal.Length",
                          "Wage from CPS85" = "CPS85$wage")),
  selectInput("explanatory", "Explan var:",
              choices = c("Choose Explanatory var" = "",
                          "cyl from mtcars" = "mtcars$cyl",
                          "Sepal width from iris" = "iris$Sepal.Width",
                          "educ from CPS85" = "CPS85$educ")),
  tableOutput("show_df"),
